...
public class WebAppMojo extends AbstractMojo {
	 ...
	 * XSL code generator implementation
	 * 
	 * @component role="org.unidal.codegen.aggregator.XmlAggregator" role-hint="dal-jdbc"
	 * @required
	 * @readonly
	 */
	...
	public Template buildTemplate(File templateFile, String moduleName, String pageName) throws Exception {
		...
		List<Field> fields = db.selectNodes(jdbcDocument, "/entities/entity[@table=$table]/member",
		      new Function<Element, Field>() {
			      @Override
	...
	protected void modifyPomFile(File pomFile, Wizard wizard, Webapp webapp) throws Exception {
		...
		// dependencies
		if (!b.checkDependency(dependencies, "org.unidal.framework", "web-framework", "2.1.3", null)) {
			if (webapp.isJstl()) {
			...
			b.checkDependency(dependencies, "org.unidal.framework", "foundation-service", "2.1.2", null);
