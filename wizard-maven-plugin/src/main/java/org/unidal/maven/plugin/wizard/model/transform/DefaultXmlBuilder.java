...
public class DefaultXmlBuilder implements IVisitor {
   ...
   public void visitPage(Page page) {
      startTag(ENTITY_PAGE, null, ATTR_NAME, page.getName(), ATTR_TITLE, page.getTitle(), ATTR_DEFAULT, page.getDefault(), ATTR_PACKAGE, page.getPackage(), ATTR_PATH, page.getPath(), ATTR_VIEW, page.getView(), ATTR_STANDALONE, page.getStandalone());
   ...
   public void visitWebapp(Webapp webapp) {
      startTag(ENTITY_WEBAPP, null, ATTR_PACKAGE, webapp.getPackage(), ATTR_NAME, webapp.getName(), ATTR_MODULE, webapp.getModule(), ATTR_CAT, webapp.getCat(), ATTR_PLUGIN_MANAGEMENT, webapp.getPluginManagement(), ATTR_JSTL, webapp.getJstl(), ATTR_LAYOUT, webapp.getLayout());
