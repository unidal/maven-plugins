...
public class DefaultXmlBuilder implements IVisitor {
   ...
   public void visitClass(ClassModel _class) {
      startTag(ENTITY_CLASS, null, ATTR_PACKAGE, _class.getPackage(), ATTR_CLASS, _class.getClazz(), ATTR_MAIN, _class.getMain(), ATTR_CODEGEN, _class.getCodegen(), ATTR_TEST, _class.getTest());
