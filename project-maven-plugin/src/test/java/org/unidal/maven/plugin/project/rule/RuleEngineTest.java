...
import static org.unidal.maven.plugin.project.rule.RuleExemption.INVISIBLE_MEMBER_CLASS_SKIPPED;
import static org.unidal.maven.plugin.project.rule.RuleFailure.CLASS_EXTENSIBILITY_DEGRADED;
import static org.unidal.maven.plugin.project.rule.RuleFailure.CLASS_REMOVED;
import static org.unidal.maven.plugin.project.rule.RuleFailure.CLASS_TYPE_CHANGED;
import static org.unidal.maven.plugin.project.rule.RuleFailure.CLASS_VISIBILITY_DEGRADED;
import static org.unidal.maven.plugin.project.rule.RuleFailure.FIELD_MEMBERSHIP_CHANGED;
import static org.unidal.maven.plugin.project.rule.RuleFailure.FIELD_REMOVED;
import static org.unidal.maven.plugin.project.rule.RuleFailure.FIELD_VISIBILITY_DEGRADED;
import static org.unidal.maven.plugin.project.rule.RuleFailure.METHOD_MEMBERSHIP_CHANGED;
import static org.unidal.maven.plugin.project.rule.RuleFailure.METHOD_REMOVED;
import static org.unidal.maven.plugin.project.rule.RuleFailure.METHOD_VISIBILITY_DEGRADED;
